...
local f0_local4 = function (f8_arg0, f8_arg1, f8_arg2, f8_arg3)
	...
	table.insert(f8_arg1, {optionDisplay = f8_arg2.stringRef, action = f8_arg2.action, param = f8_arg2.param, customId = f8_arg2.customId, isLargeButton = f8_arg3, isLastButtonInGroup = false, disabled = f8_arg2.disabled, selected = f8_arg2.selected, isBreadcrumbNew = f8_arg2.isBreadcrumbNew, warning = f8_arg2.warning, requiredChunk = f8_arg2.selectedParam, starterPackUpgrade = f8_arg2.starterPackUpgrade, unloadMod = f8_arg2.unloadMod})
end
